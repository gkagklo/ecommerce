...
<head>
    ...
    <body>
        ...
        @endif       
            ...
            <form id="recoverform" action="{{ url('/recover-password') }}" method="post" class="form-vertical">
                {{csrf_field()}}
				<p class="normal_text">Enter your e-mail address below and we will send you instructions how to recover a password.</p>				
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lo"><i class="icon-envelope"></i></span><input type="email" name="email"  id="email"  placeholder="E-mail address" />
                        </div>
                    </div>      
                <div class="form-actions">
