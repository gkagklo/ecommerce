        ...
        <div class="row">
            ...
            <div class="col-sm-5 ">
                <div class="login-form"><!--login form-->
                    ...
                    <div class="panel-heading"><h2 style="text-align:center;margin-bottom:15px;color:orange;font-weight:bold;">Login to your account</h2></div>
                    ...
                    <form id="loginForm" name="loginForm" method="post" action="{{ url('/user-login') }}">
                       ...
                       <!-- <span>
                        ...
                        <div class="text-center"><a onmouseover="this.style.color='orange';" style="color:black; text-decoration-line: underline;" href="{{ url('forgot-password') }}">Forgot Password?</a></div>
            ...
            <div class="col-sm-5">
                <div class="signup-form"><!--sign up form-->
                    <div class="panel panel-default">
                    <div class="panel-heading"><h2 style="text-align:center;margin-bottom:15px;color:orange;font-weight:bold;">New User Sign up!</h2></div>
                    <div class="panel-body">
                <form id="registerForm"  name="registerForm" method="POST" action="{{ url('/user-register') }}">
                    ...
                    <div style="margin-bottom:10px;" class="input-group">
                         <div class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></div>
                            <input for="myPassword" id="myPassword" name="password" type="password" placeholder="Password" class="form-control"  />
                     </div>
                  ...
                  <br>
                  <center><button id="signup" type="submit"  class="btn btn-default" >Sign up</button> </center>
                    </form>
                    </div>
                </div>
            </div><!--/sign up form-->
