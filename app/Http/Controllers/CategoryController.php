...
class CategoryController extends Controller
{
    ...
    public function editCategory(Request $request,$id=null){
        ...
        if($request->isMethod('post')){
            ...
            Category::where(['id'=>$id])->update(['status'=>$status,'name'=>$data['category_name'],'parent_id'=>$data['parent_id'],'description'=>$data['description'],'meta_title'=>$data['meta_title'],'meta_description'=>$data['meta_description'],'meta_keywords'=>$data['meta_keywords'],'url'=>$data['url']]);
